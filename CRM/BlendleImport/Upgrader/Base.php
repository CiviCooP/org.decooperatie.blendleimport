 ...
 */
class CRM_BlendleImport_Upgrader_Base {
  ...
  static public function instance() {
    if (!self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_BlendleImport_Upgrader(
        'org.decooperatie.blendleimport',
        realpath(__DIR__ . '/../../../')
      );
    }
   ...
   *
   * @code
   * CRM_BlendleImport_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * @endcode
   */
